  ...
  return (
    <Flex flexDirection="column" gap={24} style={{ padding: '24px' }}>
      <Flex flexDirection="column" gap={4}>
        ...
        <Text>Application service health using Rate, Errors, and Duration (RED) metrics.</Text>
      </Flex>
      ...
      <Flex gap={16} flexWrap="wrap">
        ...
        <StatusCard
          ...
          status={unhealthySvc.loading ? 'unknown' : badSvcs === 0 ? 'healthy' : badSvcs <= 3 ? 'warning' : 'critical'}
